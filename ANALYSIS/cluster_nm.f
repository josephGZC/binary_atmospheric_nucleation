...
c 	   write(8,*) ".",fr,tally(mercnt)
     ...
     &         typcnt5*3+typcnt6*5+typcnt8*10
   	 write(ggg,*) "Size/WNBAMCO/atoms",clustersize,"|",
     ...
     &    typcnt6,typcnt8,"|",skips
   	 do cc=1,pop
   	  if ( nuc(cc) .eq. i ) then
   	   k=molty(cc)
   	 if ( k .eq. 1 ) then
   	  write(ggg,sf) "SOL"," OW",cc,x(cc,k,1),y(cc,k,1),z(cc,k,1)
   	  write(ggg,sf) "SOL","HW1",cc,x(cc,k,2),y(cc,k,2),z(cc,k,2)
   	  write(ggg,sf) "SOL","HW2",cc,x(cc,k,3),y(cc,k,3),z(cc,k,3)
   	  write(ggg,sf) "SOL"," MW",cc,x(cc,k,4),y(cc,k,4),z(cc,k,4)
   	 elseif ( k .eq. 2 ) then
   	  write(ggg,sf) "NON","C09A",cc,x(cc,k,1),y(cc,k,1),z(cc,k,1)
   	  write(ggg,sf) "NON","C09B",cc,x(cc,k,2),y(cc,k,2),z(cc,k,2)
   	  write(ggg,sf) "NON","C09C",cc,x(cc,k,3),y(cc,k,3),z(cc,k,3)
   	  write(ggg,sf) "NON","C09D",cc,x(cc,k,4),y(cc,k,4),z(cc,k,4)
   	  write(ggg,sf) "NON","C09E",cc,x(cc,k,5),y(cc,k,5),z(cc,k,5)
   	  write(ggg,sf) "NON","C09F",cc,x(cc,k,6),y(cc,k,6),z(cc,k,6)
   	  write(ggg,sf) "NON","C09G",cc,x(cc,k,7),y(cc,k,7),z(cc,k,7)
   	  write(ggg,sf) "NON","C09H",cc,x(cc,k,8),y(cc,k,8),z(cc,k,8)
   	  write(ggg,sf) "NON","C09I",cc,x(cc,k,9),y(cc,k,9),z(cc,k,9)
   	 elseif ( k .eq. 3 ) then
   	  write(ggg,sf) "BUTA","CAA",cc,x(cc,k,1),y(cc,k,1),z(cc,k,1)
   	  write(ggg,sf) "BUTA","CAB",cc,x(cc,k,2),y(cc,k,2),z(cc,k,2)
   	  write(ggg,sf) "BUTA","CAC",cc,x(cc,k,3),y(cc,k,3),z(cc,k,3)
   	  write(ggg,sf) "BUTA","CAD",cc,x(cc,k,4),y(cc,k,4),z(cc,k,4)
   	  write(ggg,sf) "BUTA","OAE",cc,x(cc,k,5),y(cc,k,5),z(cc,k,5)
   	  write(ggg,sf) "BUTA","HAJ",cc,x(cc,k,6),y(cc,k,6),z(cc,k,6)
   	 elseif ( k .eq. 4 ) then
   	  write(ggg,sf) "NH3","N1",cc,x(cc,k,1),y(cc,k,1),z(cc,k,1)
   	  write(ggg,sf) "NH3","H1",cc,x(cc,k,2),y(cc,k,2),z(cc,k,2)
   	  write(ggg,sf) "NH3","H2",cc,x(cc,k,3),y(cc,k,3),z(cc,k,3)
   	  write(ggg,sf) "NH3","H3",cc,x(cc,k,4),y(cc,k,4),z(cc,k,4)
   	  write(ggg,sf) "NH3","DN",cc,x(cc,k,5),y(cc,k,5),z(cc,k,5)
   	 elseif ( k .eq. 5 ) then
   	  write(ggg,sf) "MET","CBA",cc,x(cc,k,1),y(cc,k,1),z(cc,k,1)
   	  write(ggg,sf) "MET","OBB",cc,x(cc,k,2),y(cc,k,2),z(cc,k,2)
   	  write(ggg,sf) "MET","HBC",cc,x(cc,k,3),y(cc,k,3),z(cc,k,3)
   	 elseif ( k .eq. 6 ) then
   	  write(ggg,sf) "ACT","CQA",cc,x(cc,k,1),y(cc,k,1),z(cc,k,1)
   	  write(ggg,sf) "ACT","CQB",cc,x(cc,k,2),y(cc,k,2),z(cc,k,2)
   	  write(ggg,sf) "ACT","OQA",cc,x(cc,k,3),y(cc,k,3),z(cc,k,3)
   	  write(ggg,sf) "ACT","OQB",cc,x(cc,k,4),y(cc,k,4),z(cc,k,4)
   	  write(ggg,sf) "ACT","HQA",cc,x(cc,k,5),y(cc,k,5),z(cc,k,5)
   	 elseif ( k .eq. 8 ) then
   	  write(ggg,sf) "OCTA","CAA",cc,x(cc,k,1),y(cc,k,1),z(cc,k,1)
   	  write(ggg,sf) "OCTA","CAB",cc,x(cc,k,2),y(cc,k,2),z(cc,k,2)
   	  write(ggg,sf) "OCTA","CAC",cc,x(cc,k,3),y(cc,k,3),z(cc,k,3)
   	  write(ggg,sf) "OCTA","CAD",cc,x(cc,k,4),y(cc,k,4),z(cc,k,4)
   	  write(ggg,sf) "OCTA","CAE",cc,x(cc,k,5),y(cc,k,5),z(cc,k,5)
   	  write(ggg,sf) "OCTA","CAF",cc,x(cc,k,6),y(cc,k,6),z(cc,k,6)
   	  write(ggg,sf) "OCTA","CAG",cc,x(cc,k,7),y(cc,k,7),z(cc,k,7)
   	  write(ggg,sf) "OCTA","CAH",cc,x(cc,k,8),y(cc,k,8),z(cc,k,8)
   	  write(ggg,sf) "OCTA","OAE",cc,x(cc,k,9),y(cc,k,9),z(cc,k,9)
   	  write(ggg,sf) "OCTA","HAJ",cc,x(cc,k,10),y(cc,k,10),z(cc,k,10)
   	 endif
   	 endif
   	 enddo
   	 enddo
